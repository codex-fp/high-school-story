...
This draft promotes the accepted narrative brainstorming material from
`_bmad-output/brainstorming-session-2026-06-13.md` into a structured Narrative
Design Document. It is full-game-first: it defines the target three-year
narrative shape while preserving Year 1 Semester 1 as the first delivery slice.
