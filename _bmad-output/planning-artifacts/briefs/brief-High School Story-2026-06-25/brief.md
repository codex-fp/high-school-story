...
`High School Story` is a nostalgic school social sim for adults who want to revisit the emotional texture of high school through a focused, structured life simulation. The player creates a student and guides them through three years of school, choosing how to spend limited time across lessons, studying, relationships, recovery, fun, and school events. The game is not about doing everything perfectly; it is about forming a personal high-school identity through repeated tradeoffs.

The core experience combines a Stardew-like "one more day" rhythm with school-calendar pressure, relationship drama, and wellbeing management. Time, energy, stress, and mood are major currencies. Lessons are full gameplay, classmates have meaningful personal arcs, and romance is an important possible part of a run. The intended emotional arc is nostalgia, attachment, and bittersweet reflection.
...
4. Build or miss relationship opportunities by investing attention, care, and repeated interaction with specific characters.
...
- Relationships through engagement: bonds grow because the player chooses to spend attention, effort, and recurring interaction on specific people.
- Identity through tradeoffs: the player's high-school identity emerges from what they repeatedly prioritize across study, relationships, fun, recovery, and activities.
...
The player creates their own protagonist. Character creation should include gender, initial attributes, favorites, and preferences such as music, films, food, and other taste markers. Initial attributes partly affect aptitude in specific school subjects and also influence compatibility with NPCs. Favorites and preferences should help the character feel personal while also giving relationship and activity systems more texture.

Classmate scope needs to balance school believability against story production cost. A practical target for the full game is 12 core classmates with meaningful relationship content and full story arcs, supported by lighter background students if the school needs to feel more populated. This keeps the relationship fantasy strong without committing the project to 20+ full arcs, which would likely be too large for a solo-dev commercial indie scope.

The MVP should include 5 classmates, with one partial story arc deep enough to demonstrate the intended relationship structure. The other MVP classmates can focus on first meetings, early compatibility, recurring interaction, and the feeling of choosing who deserves the player's limited time.
